...
function myFunction(x, y) {
  for (var i = 0; i <= 3; i++) {
    ...
    // console.log(parseInt(positie[0][0]));
    }
  }
}
...
for(ent in 1:length(entiteit)) {
  ...
  cat('<script> 
      ...
      // console.log(document.getElementById("',paste0(ent,1,"o"),'").innerText)
      
      faseSelect(Number(positie[0][0]), 
                 4, 
                 4, 
                 faseSelectId, faseId, \'',paste0(ent,"o"),'\') 
...
for(ent in 1:length(entiteit)) {
  ...
  cat('<script> 
      ...
      faseSelect(1, 1, 1, faseSelectId, faseId, \'',paste0(ent,"ao"),'\') 
