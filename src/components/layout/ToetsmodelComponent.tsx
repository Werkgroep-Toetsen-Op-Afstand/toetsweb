        ...
        <div className='toetsmodel-component'>
            ...
            <svg width="672" height="672" viewBox="0 0 1030 1065" fill="none" xmlns="http://www.w3.org/2000/svg" className={'svg-model'} id={name}>
                ...
                <Popup
                    ...
                    trigger={
                        <path id="Path_248" d="M161.821 501.6C161.713 463.692 167.578 426.004 179.201 389.922L117.974 369.636C104.194 412.266 97.206 456.798 97.266 501.6C97.266 645.133 167.366 772.131 275.137 850.739L312.803 798.387C221.411 731.401 161.821 623.421 161.821 501.6" fill={toetsbekwaamheid === "4" || toetsbekwaamheid === "0" ? "#46AD48" : "#909090"}/>
                    }
                >
                ...
                <Popup
                    ...
                    contentStyle={{ padding: '0px', border: 'none' }}
                    trigger={
                        <path id="Path_251" d="M290.898 501.607C290.85 477.477 294.484 453.481 301.675 430.448L240.448 410.162C221.379 470.58 221.718 535.455 241.417 595.67C261.117 655.886 299.186 708.417 350.277 745.883L387.943 693.531C357.86 671.382 333.404 642.472 316.547 609.135C299.69 575.797 290.904 538.964 290.898 501.607" fill={toetsbekwaamheid === "2" || toetsbekwaamheid === "0" ? "#46AD48" : "#909090"}/>
                    }
                >
                    <div className='toetsmodel-component__element-hover green'>
                ...
                <Popup
                    ...
                    contentStyle={{ padding: '0px', border: 'none' }}
                    trigger={
                        <path id="Path_253" d="M301.654 430.421C286.931 477.769 287.327 528.528 302.788 575.64C318.249 622.752 348.006 663.875 387.922 693.292L523.795 504.01L301.654 430.421Z" fill={toetsbekwaamheid === "1" || toetsbekwaamheid === "0" ? "#46AD48" : "#909090"}/>
                    }
                >
                    <div className='toetsmodel-component__element-hover green'>
                ...
                <Popup
                    ...
                    contentStyle={{ padding: '0px', border: 'none' }}
                    trigger={
                        <path id="Path_255" d="M528.976 868.543C452.146 868.714 377.227 844.604 314.917 799.656L276.67 851.586C350.206 904.648 438.601 933.169 529.282 933.093C619.963 933.017 708.31 904.348 781.757 851.163L743.457 799.233C681.082 844.418 605.997 868.682 528.976 868.543" fill={toetsorganisatie === "4" || toetsbekwaamheid === "0" ? "#ED7A0F" : "#909090"}/>
                    }
                >
                ...
                <Popup
                    ...
                    contentStyle={{ padding: '0px', border: 'none' }}
                    trigger={
                        <path id="Path_256" d="M528.95 804.195C465.906 804.28 404.42 784.604 353.139 747.933L314.891 799.863C377.402 844.716 452.421 868.805 529.359 868.729C606.297 868.653 681.268 844.416 743.691 799.44L705.447 747.511C653.986 784.393 592.259 804.217 528.947 804.195" fill={toetsorganisatie === "3" || toetsbekwaamheid === "0" ? "#ED7A0F" : "#909090"}/>
                    }
                >
                    <div className='toetsmodel-component__element-hover orange'>
                        <h4>3. SYSTEEM-GEORIËNTEERDE ONTWIKKELINGSFASE</h4>
                ...
                <Popup
                    ...
                    contentStyle={{ padding: '0px', border: 'none' }}
                    trigger={
                        <path id="Path_258" d="M528.987 739.692C479.678 739.801 431.573 724.468 391.423 695.845L353.176 747.774C404.603 784.444 466.209 804.118 529.372 804.042C592.534 803.966 654.092 784.144 705.432 747.351L667.185 695.422C626.879 724.263 578.547 739.745 528.985 739.692" fill={toetsorganisatie === "2" || toetsbekwaamheid === "0" ? "#ED7A0F" : "#909090"}/>
                    }
                >
                    <div className='toetsmodel-component__element-hover orange'>
                        <h4>2. PROCES-GEORIËNTEERDE ONTWIKKELINGSFASE</h4>
                ...
                <Popup
                    ...
                    contentStyle={{ padding: '0px', border: 'none' }}
                    trigger={
                        <path id="Path_260" d="M391.227 695.815C431.526 724.411 479.735 739.736 529.149 739.661C578.563 739.585 626.724 724.111 666.936 695.392L529.161 508.223L391.227 695.815Z" fill={toetsorganisatie === "1" || toetsbekwaamheid === "0" ? "#ED7A0F" : "#909090"}/>
                    }
                >
                    <div className='toetsmodel-component__element-hover orange'>
                        <h4>1. ACTIVITEITEN-GEORIËNTEERDE ONTWIKKELINGSFASE</h4>
                ...
                <Popup
                    ...
                    contentStyle={{ padding: '0px', border: 'none' }}
                    trigger={
                        <path id="Path_265" d="M766.827 501.576C766.848 538.805 758.119 575.518 741.345 608.755C724.571 641.991 700.22 670.82 670.258 692.918L707.924 745.27C758.884 707.899 796.847 655.493 816.472 595.424C836.097 535.354 836.398 470.644 817.331 410.395L756.103 430.681C763.226 453.639 766.841 477.542 766.827 501.581" fill={toetsbeleid === "2" || toetsbekwaamheid === "0" ? "#AF72AD" : "#909090"}/>
                    }
                >
                    <div className='toetsmodel-component__element-hover purple'>
                        <h4>2. PROCES-GEORIËNTEERDE ONTWIKKELINGSFASE</h4>
                ...
                <Popup
                    ...
                    contentStyle={{ padding: '0px', border: 'none' }}
                    trigger={
                        <path id="Path_267" d="M670.416 692.912C700.366 670.803 724.707 641.971 741.479 608.737C758.252 575.503 766.989 538.796 766.985 501.569C767.036 477.578 763.404 453.722 756.216 430.833L534.916 504.264L670.416 692.912Z" fill={toetsbeleid === "1" || toetsbekwaamheid === "0" ? "#AF72AD" : "#909090"}/>
                    }
                >
                    <div className='toetsmodel-component__element-hover purple'>
                        <h4>1. ACTIVITEITEN-GEORIËNTEERDE ONTWIKKELINGSFASE</h4>
                ...
                <Popup
                    ...
                    contentStyle={{ padding: '0px', border: 'none' }}
                    trigger={
                        <path id="Path_269" d="M877.898 387.651L939.338 367.999C883.286 195.516 721.317 70.5783 530.186 69.9443L530.609 134.5C692.791 135.292 830.142 241.159 877.898 387.651Z" fill={toetsprogramma === "4" || toetsbekwaamheid === "0" ? "#2DB3A5" : "#909090"}/>
                    }
                >
                ...
                <Popup
                    ...
                    contentStyle={{ padding: '0px', border: 'none' }}
                    trigger={
                        <path id="Path_270" d="M816.475 407.267L877.914 387.615C830.104 241.179 692.752 135.259 530.623 134.467L531.046 199.023C594.432 199.494 656.071 219.844 707.278 257.204C758.485 294.564 796.678 347.05 816.475 407.267Z" fill={toetsprogramma === "3" || toetsbekwaamheid === "0" ? "#2DB3A5" : "#909090"}/>
                    }
                >
                    <div className='toetsmodel-component__element-hover turquoise'>
                        <h4>3. SYSTEEM-GEORIËNTEERDE ONTWIKKELINGSFASE</h4>
                ...
                <Popup
                    ...
                    contentStyle={{ padding: '0px', border: 'none' }}
                    trigger={
                        <path id="Path_272" d="M531.035 199.001L531.458 263.557C581.085 264.052 629.316 280.048 669.403 309.308C709.49 338.568 739.427 379.627 755.025 426.742L816.464 407.09C796.631 346.909 758.424 294.462 707.221 257.133C656.019 219.805 594.399 199.473 531.035 199.001" fill={toetsprogramma === "2" || toetsbekwaamheid === "0" ? "#2DB3A5" : "#909090"}/>
                    }
                >
                    <div className='toetsmodel-component__element-hover turquoise'>
                        <h4>2. PROCES-GEORIËNTEERDE ONTWIKKELINGSFASE</h4>
                ...
                <Popup
                    ...
                    contentStyle={{ padding: '0px', border: 'none' }}
                    trigger={
                        <path id="Path_274" d="M755.013 426.952C739.425 379.831 709.49 338.765 669.401 309.503C629.312 280.242 581.075 264.25 531.445 263.767L532.871 497.689L755.013 426.952Z" fill={toetsprogramma === "1" || toetsbekwaamheid === "0" ? "#2DB3A5" : "#909090"}/>
                    }
                >
                    <div className='toetsmodel-component__element-hover turquoise'>
                        <h4>1. ACTIVITEITEN-GEORIËNTEERDE ONTWIKKELINGSFASE</h4>
                ...
                <Popup
                    ...
                    contentStyle={{ padding: '0px', border: 'none' }}
                    trigger={
                        <path id="Path_276" d="M528.129 134.447L528.552 69.8906C336.997 70.1016 174.869 195.04 118.607 367.735L180.046 387.391C227.807 241 365.577 134.869 528.129 134.447Z" fill={toetstaken === "4" || toetsbekwaamheid === "0" ? "#45A7C3" : "#909090"}/>
                    }
                >
                ...
                <Popup
                    ...
                    contentStyle={{ padding: '0px', border: 'none' }}
                    trigger={
                        <path id="Path_277" d="M527.727 198.97L528.15 134.414C365.599 134.837 228.035 240.756 180.014 387.407L241.453 407.059C261.32 346.734 299.652 294.183 351.026 256.84C402.4 219.497 464.215 199.252 527.727 198.97" fill={toetstaken === "3" || toetsbekwaamheid === "0" ? "#45A7C3" : "#909090"}/>
                    }
                >
                    <div className='toetsmodel-component__element-hover blue'>
                        <h4>3. SYSTEEM-GEORIËNTEERDE ONTWIKKELINGSFASE</h4>
                ...
                <Popup
                    ...
                    contentStyle={{ padding: '0px', border: 'none' }}
                    trigger={
                        <path id="Path_279" d="M527.34 263.504L527.763 198.948C464.279 199.22 402.484 219.435 351.114 256.737C299.744 294.04 261.395 346.543 241.488 406.826L302.927 426.478C318.649 379.292 348.74 338.208 388.983 308.982C429.226 279.756 477.605 263.854 527.34 263.504" fill={toetstaken === "2" || toetsbekwaamheid === "0" ? "#45A7C3" : "#909090"}/>
                    }
                >
                    <div className='toetsmodel-component__element-hover blue'>
                        <h4>2. PROCES-GEORIËNTEERDE ONTWIKKELINGSFASE</h4>
                ...
                <Popup
                    ...
                    contentStyle={{ padding: '0px', border: 'none' }}
                    trigger={
                        <path id="Path_281" d="M527.325 263.534C422.884 264.168 334.345 332.422 302.912 426.508L525.898 497.456L527.325 263.534Z" fill={toetstaken === "1" || toetsbekwaamheid === "0" ? "#46A8C4" : "#909090"}/>
                    }
                >
                    <div className='toetsmodel-component__element-hover blue'>
                        <h4>1. ACTIVITEITEN-GEORIËNTEERDE ONTWIKKELINGSFASE</h4>
                ...
                <Popup
                    ...
                    trigger={
                        <g id="blue-1">
                            <path id="Blue_-_1-2" d="M399.019 371.909C412.149 371.909 422.792 361.266 422.792 348.136C422.792 335.007 412.149 324.363 399.019 324.363C385.89 324.363 375.246 335.007 375.246 348.136C375.246 361.266 385.89 371.909 399.019 371.909Z" fill={toetstaken === "1" || toetsbekwaamheid === "0" ? "#A2D3E1" : "#c7c7c7"}/>
                ...
                <Popup
                    ...
                    trigger={
                        <g id="blue-2">
                            <path id="Blue_-_2-2" d="M350.47 323.836C363.6 323.836 374.243 313.193 374.243 300.063C374.243 286.934 363.6 276.29 350.47 276.29C337.341 276.29 326.697 286.934 326.697 300.063C326.697 313.193 337.341 323.836 350.47 323.836Z" fill={toetstaken === "2" || toetsbekwaamheid === "0" ? "#87C6D9" : "#b6b6b6"}/>
                ...
                <Popup
                    ...
                    trigger={
                        <g id="blue-3">
                            <path id="Blue_-_3-2" d="M301.869 278.668C314.998 278.668 325.642 268.025 325.642 254.895C325.642 241.766 314.998 231.122 301.869 231.122C288.739 231.122 278.096 241.766 278.096 254.895C278.096 268.025 288.739 278.668 301.869 278.668Z" fill={toetstaken === "3" || toetsbekwaamheid === "0" ? "#74BED3" : "#ababab"}/>
                ...
                <Popup
                    ...
                    trigger={
                        <g id="blue-4">
                            <path id="Blue_-_4-2" d="M258.074 231.123C271.203 231.123 281.847 220.48 281.847 207.35C281.847 194.221 271.203 183.577 258.074 183.577C244.944 183.577 234.301 194.221 234.301 207.35C234.301 220.48 244.944 231.123 258.074 231.123Z" fill={toetstaken === "4" || toetsbekwaamheid === "0" ? "#45A7C3" : "#909090"}/>
                ...
                <Popup
                    ...
                    trigger={
                        <g id="purple-1">
                            <path id="Paars_-_1-2" d="M720.628 587.447C733.758 587.447 744.401 576.804 744.401 563.674C744.401 550.545 733.758 539.901 720.628 539.901C707.499 539.901 696.855 550.545 696.855 563.674C696.855 576.804 707.499 587.447 720.628 587.447Z" fill={toetsbeleid === "1" || toetsbekwaamheid === "0" ? "#D7B8D6" : "c7c7c7"}/>
                ...
                <Popup
                    ...
                    trigger={
                        <g id="purple-2">
                            <path id="Paars_-_2-2" d="M778.896 620.785C792.026 620.785 802.669 610.142 802.669 597.012C802.669 583.883 792.026 573.239 778.896 573.239C765.767 573.239 755.123 583.883 755.123 597.012C755.123 610.142 765.767 620.785 778.896 620.785Z" fill={toetsbeleid === "4" || toetsbekwaamheid === "0"? "#CBA3CA" : "#b6b6b6"}/>
                ...
                <Popup
                    ...
                    trigger={
                        <g id="purple-3">
                            <path id="Paars_-_3-2" d="M835 660.719C848.129 660.719 858.773 650.075 858.773 636.946C858.773 623.816 848.129 613.173 835 613.173C821.87 613.173 811.227 623.816 811.227 636.946C811.227 650.075 821.87 660.719 835 660.719Z" fill={toetsbeleid === "3" || toetsbekwaamheid === "0" ? "#C395C1" : "#ababab"}/>
                ...
                <Popup
                    ...
                    trigger={
                        <g id="purple-4">
                            <path id="Paars_-_4-2" d="M889.941 695.955C903.07 695.955 913.714 685.312 913.714 672.182C913.714 659.053 903.07 648.409 889.941 648.409C876.812 648.409 866.168 659.053 866.168 672.182C866.168 685.312 876.812 695.955 889.941 695.955Z" fill={toetsbeleid === "4" || toetsbekwaamheid === "0" ? "#AF72AD" : "#909090"}/>
                ...
                <Popup
                    ...
                    trigger={
                        <g id="green-1">
                            <path id="Groen_-_1c" d="M336.259 587.975C349.389 587.975 360.032 577.331 360.032 564.202C360.032 551.072 349.389 540.429 336.259 540.429C323.13 540.429 312.486 551.072 312.486 564.202C312.486 577.331 323.13 587.975 336.259 587.975Z" fill={toetsbekwaamheid === "1" || toetsbekwaamheid === "0" ? "#A2D6A3" : "#c7c7c7"}/>
                ...
                <Popup
                    ...
                    trigger={
                        <g id="green-2">
                            <path id="Groen_-_2c" d="M272.179 614.283C285.309 614.283 295.952 603.64 295.952 590.51C295.952 577.381 285.309 566.737 272.179 566.737C259.05 566.737 248.406 577.381 248.406 590.51C248.406 603.64 259.05 614.283 272.179 614.283Z" fill={toetsbekwaamheid === "2" || toetsbekwaamheid === "0" ? "#87CA88" : "#b6b6b6"}/>
                ...
                <Popup
                    ...
                    trigger={
                        <g id="green-3">
                            <path id="Groen_-_3c" d="M214.384 640.275C227.514 640.275 238.157 629.631 238.157 616.502C238.157 603.372 227.514 592.729 214.384 592.729C201.255 592.729 190.611 603.372 190.611 616.502C190.611 629.631 201.255 640.275 214.384 640.275Z" fill={toetsbekwaamheid === "3" || toetsbekwaamheid === "0" ? "#74C176" : "#ababab"}/>
                ...
                <Popup
                    ...
                    trigger={
                        <g id="green-4">
                            <path id="Groen_-_4c" d="M159.443 673.767C172.572 673.767 183.216 663.123 183.216 649.994C183.216 636.864 172.572 626.221 159.443 626.221C146.313 626.221 135.67 636.864 135.67 649.994C135.67 663.123 146.313 673.767 159.443 673.767Z" fill={toetsbekwaamheid === "4" || toetsbekwaamheid === "0" ? "#46AD48" : "#909090"}/>
                ...
                <Popup
                    ...
                    trigger={
                        <g id="orange-1">
                            <path id="Oranje_-_1-2" d="M530.134 733.357C543.264 733.357 553.907 722.713 553.907 709.584C553.907 696.454 543.264 685.811 530.134 685.811C517.005 685.811 506.361 696.454 506.361 709.584C506.361 722.713 517.005 733.357 530.134 733.357Z" fill={toetsorganisatie === "1" || toetsbekwaamheid === "0" ? "#F6BC87" : "#c7c7c7"}/>
                ...
                <Popup
                    ...
                    trigger={
                        <g id="orange-2">
                            <path id="Oranje_-_2-2" d="M529.605 795.43C542.734 795.43 553.378 784.786 553.378 771.657C553.378 758.527 542.734 747.884 529.605 747.884C516.476 747.884 505.832 758.527 505.832 771.657C505.832 784.786 516.476 795.43 529.605 795.43Z" fill={toetsorganisatie === "2" || toetsbekwaamheid === "0" ? "#F3A963" : "#b6b6b6"}/>
                ...
                <Popup
                    ...
                    trigger={
                        <g id="orange-3">
                            <path id="Oranje_-_3-2" d="M529.605 862.257C542.734 862.257 553.378 851.613 553.378 838.484C553.378 825.354 542.734 814.711 529.605 814.711C516.476 814.711 505.832 825.354 505.832 838.484C505.832 851.613 516.476 862.257 529.605 862.257Z" fill={toetsorganisatie === "3" || toetsbekwaamheid === "0" ? "#F19B4B" : "#ababab"}/>
                ...
                <Popup
                    ...
                    trigger={
                        <g id="orange-4">
                            <path id="Oranje_-_4-2" d="M531.191 925.598C544.32 925.598 554.964 914.954 554.964 901.825C554.964 888.695 544.32 878.052 531.191 878.052C518.062 878.052 507.418 888.695 507.418 901.825C507.418 914.954 518.062 925.598 531.191 925.598Z" fill={toetsorganisatie === "4" || toetsbekwaamheid === "0" ? "#ED7A0F" : "#909090"}/>
                ...
                <Popup
                    ...
                    trigger={
                        <g id="turqoise-1">
                            <path id="Turqoise_-_1-2" d="M662.728 369.268C675.858 369.268 686.501 358.624 686.501 345.495C686.501 332.365 675.858 321.722 662.728 321.722C649.599 321.722 638.955 332.365 638.955 345.495C638.955 358.624 649.599 369.268 662.728 369.268Z" fill={toetsprogramma === "1" || toetsbekwaamheid === "0" ? "#96D9D2" : "#c7c7c7"}/>
                ...
                <Popup
                    ...
                    trigger={
                        <g id="turqoise-2">
                            <path id="Turqoise_-_2-2" d="M710.273 321.723C723.402 321.723 734.046 311.079 734.046 297.95C734.046 284.82 723.402 274.177 710.273 274.177C697.144 274.177 686.5 284.82 686.5 297.95C686.5 311.079 697.144 321.723 710.273 321.723Z" fill={toetsprogramma === "2" || toetsbekwaamheid === "0" ? "#77CEC5" : "#b6b6b6"}/>
                ...
                <Popup
                    ...
                    trigger={
                        <g id="turqoise-3">
                            <path id="Turqoise_-_3-2" d="M756.287 278.668C769.416 278.668 780.06 268.025 780.06 254.895C780.06 241.766 769.416 231.122 756.287 231.122C743.157 231.122 732.514 241.766 732.514 254.895C732.514 268.025 743.157 278.668 756.287 278.668Z" fill={toetsprogramma === "3" || toetsbekwaamheid === "0" ? "#62C6BB" : "#ababab"}/>
                ...
                <Popup
                    ...
                    trigger={
                        <g id="turqoise-4">
                            <path id="Turqoise_-_4-2" d="M801.877 234.293C815.006 234.293 825.65 223.65 825.65 210.52C825.65 197.391 815.006 186.747 801.877 186.747C788.747 186.747 778.104 197.391 778.104 210.52C778.104 223.65 788.747 234.293 801.877 234.293Z" fill={toetsprogramma === "4" || toetsbekwaamheid === "0" ? "#2DB3A5" : "#909090"}/>
