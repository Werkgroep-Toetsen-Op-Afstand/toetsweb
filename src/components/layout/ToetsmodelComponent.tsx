        ...
        <div className='toetsmodel-component'>
            ...
            <svg width="672" height="672" viewBox="0 0 1030 1065" fill="none" xmlns="http://www.w3.org/2000/svg" className={'svg-model'}>
                ...
                <Popup
                    ...
                    trigger={
                        <g id="purple-2">
                            <path id="Paars_-_2-2" d="M778.896 620.785C792.026 620.785 802.669 610.142 802.669 597.012C802.669 583.883 792.026 573.239 778.896 573.239C765.767 573.239 755.123 583.883 755.123 597.012C755.123 610.142 765.767 620.785 778.896 620.785Z" fill={toetsbeleid === "2" || toetsbekwaamheid === "0"? "#CBA3CA" : "#b6b6b6"}/>
