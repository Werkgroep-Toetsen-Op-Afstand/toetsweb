...
const ToetsmodelComponent: FunctionComponent<Props> = ({results = null}) => {
    ...
    if (results != null) {
        ...
        toetsprogramma = results[2][1]
        toetsbeleid = results[3][1]
    ...
    return (
        <div className='toetsmodel-component'>
            ...
            <svg width="672" height="672" viewBox="0 0 1030 1065" fill="none" xmlns="http://www.w3.org/2000/svg"
                ...
                <g id="Group_75">
                    <path id="Path_247"
                          d="M528.551 0C805.475 0 1029.94 224.466 1029.94 501.389C1029.94 778.312 805.474 1002.78 528.551 1002.78C251.628 1002.78 27.1621 778.313 27.1621 501.389C27.1621 224.465 251.628 0 528.551 0Z"
                          fill="white"/>
                    ...
                    <Popup
                        ...
                        trigger={
                            <path id="Path_248"
                                  d="M161.821 501.6C161.713 463.692 167.578 426.004 179.201 389.922L117.974 369.636C104.194 412.266 97.206 456.798 97.266 501.6C97.266 645.133 167.366 772.131 275.137 850.739L312.803 798.387C221.411 731.401 161.821 623.421 161.821 501.6"
                                  fill={toetsbekwaamheid === "4" || toetsbekwaamheid === "0" ? "#46AD48" : "#909090"}/>
                        }
                    >
                        <div className='toetsmodel-component__element-hover green'>
                            <h4>4. KETEN-GEORIËNTEERDE ONTWIKKELINGSFASE </h4>
                            <p>
                                De eisen die gesteld worden aan toetsbekwaamheid worden besproken met in- en/of
                                relevante externe partners en sluiten aan bij de landelijke kaders Ook voor de partners
                                uit het werkveld is vastgelegd over welke toetsbekwaamheid zij moeten beschikken. De
                                kwaliteit van de toetsbekwaamheid van alle partners in de toetsorganisatie wordt
                                structureel geëvalueerd aan de hand van de de eisen die aan toetsbekwaamheid zijn
                                gesteld, de opbrengsten worden besproken met zowel de relevante partners binnen de
                                opleiding als het werkveld.
                            </p>
                        </div>
                    </Popup>
                    ...
                    <g id="Group_25" opacity="0.75">
                        <g id="Group_24">
                            <g id="Group 1">
                                <g id="Group_23">
                                    <mask id="mask0_0_1" style={{maskType: 'alpha'}} maskUnits="userSpaceOnUse" x="161"
                                          y="389" width="190" height="410">
                                        <path id="clip-path-3" d="M350.248 389.902H161.811V798.209H350.248V389.902Z"
                                              fill="white"/>
                                    </mask>
                                    <g mask="url(#mask0_0_1)">
                                        <g id="Group">
                                            ...
                                            <Popup
                                                ...
                                                trigger={
                                                    <path id="Path_249"
                                                          d="M226.366 501.581C226.374 470.562 231.113 439.726 240.418 410.136L179.19 389.85C155.76 463.296 156.035 542.254 179.975 615.535C203.916 688.817 250.309 752.708 312.581 798.157L350.247 745.805C311.815 717.737 280.56 680.984 259.032 638.542C237.503 596.1 226.311 549.171 226.366 501.581"
                                                          fill={toetsbekwaamheid === "3" || toetsbekwaamheid === "0" ? "#46AD48" : "#909090"}/>
                                                }
                                            >
                                                <div className='toetsmodel-component__element-hover green'>
                                                    <h4>3. SYSTEEM-GEORIËNTEERDE ONTWIKKELINGSFASE</h4>
                                                    <p>
                                                        De eisen die gesteld worden aan toetsbekwaamheid worden
                                                        regelmatig bijgesteld op basis van (landelijke) kaders en
                                                        actuele (wetenschappelijke) inzichten. De vereiste
                                                        toetsbekwaamheid is niet alleen op individueel niveau, maar ook
                                                        op teamniveau vastgesteld. Er wordt doelgericht gewerkt aan het
                                                        professionaliseren van medewerkers en teams. De kwaliteit van de
                                                        toetsbekwaamheid wordt structureel geëvalueerd aan de hand van
                                                        de eisen die aan toetsbekwaamheid zijn gesteld. De opbrengsten
                                                        hiervan worden besproken met relevante partners binnen de
                                                        opleiding en dienen als basis voor het opstellen van
                                                        ontwikkelplannen.
                                                    </p>
                                                </div>
                                            </Popup>
                                    ...
                                    <g mask="url(#mask1_0_1)">
                                        <g id="Group_2">
                                            ...
                                            <Popup
                                                ...
                                                trigger={
                                                    <path id="Path_251"
                                                          d="M290.898 501.607C290.85 477.477 294.484 453.481 301.675 430.448L240.448 410.162C221.379 470.58 221.718 535.455 241.417 595.67C261.117 655.886 299.186 708.417 350.277 745.883L387.943 693.531C357.86 671.382 333.404 642.472 316.547 609.135C299.69 575.797 290.904 538.964 290.898 501.607"
                                                          fill={toetsbekwaamheid === "2" || toetsbekwaamheid === "0" ? "#46AD48" : "#909090"}/>
                                                }
                                            >
                                                <div className='toetsmodel-component__element-hover green'>
                                                    <h4>2. PROCES-GEORIËNTEERDE ONTWIKKELINGSFASE</h4>
                                                    <p>
                                                        De eisen die binnen de opleiding gesteld worden aan
                                                        toetsbekwaamheid zijn gebaseerd op ervaringen van ervaren
                                                        toetsontwikkelaars. Voor alle medewerkers in de toetsorganisatie
                                                        is vastgelegd over welke toetsbekwaamheid zij moeten beschikken.
                                                        Om deze bekwaamheid te realiseren zijn concrete doelen
                                                        geformuleerd. Zowel de stand van zaken t.a.v. de ontwikkeling
                                                        van de toetsbekwaamheid als de kwaliteit van de toetsbekwaamheid
                                                        worden met enige regelmaat geëvalueerd. De opbrengsten daarvan
                                                        worden niet vanzelfsprekend besproken met alle collega’s of
                                                        studenten, maar wel gebruikt om acties in te zetten om de
                                                        toetsbekwaamheid te verhogen.
                                                    </p>
                                                </div>
                                            </Popup>
                                        </g>
                                    ...
                                    <g mask="url(#mask2_0_1)">
                                        <g id="Group_3">
                                            ...
                                            <Popup
                                                ...
                                                trigger={
                                                    <path id="Path_253"
                                                          d="M301.654 430.421C286.931 477.769 287.327 528.528 302.788 575.64C318.249 622.752 348.006 663.875 387.922 693.292L523.795 504.01L301.654 430.421Z"
                                                          fill={toetsbekwaamheid === "1" || toetsbekwaamheid === "0" ? "#46AD48" : "#909090"}/>
                                                }
                                            >
                                                <div className='toetsmodel-component__element-hover green'>
                                                    <h4>1. ACTIVITEITEN-GEORIËNTEERDE ONTWIKKELINGSFASE</h4>
                                                    <p>
                                                        Binnen de opleiding zijn geen (concrete) afspraken gemaakt over
                                                        de toetsbekwaamheid die van docenten wordt verwacht. De
                                                        verantwoordelijkheid voor de ontwikkeling van toetsbekwaamheid
                                                        ligt bij individuele docenten. Uitsluitend wanneer daar
                                                        aanleiding toe is, wordt de toetsbekwaamheid van docenten
                                                        geëvalueerd.
                                                    </p>
                                                </div>
                                            </Popup>
                    ...
                    <path id="Path_254"
                          d="M388.084 694.792L387.239 694.158C347.174 664.613 317.304 623.325 301.778 576.028C286.252 528.73 285.841 477.772 300.601 430.23L301.024 429.173L525.437 503.66L388.084 694.792ZM302.291 431.867C288.009 478.728 288.55 528.857 303.841 575.399C319.131 621.941 348.424 662.625 387.714 691.886L522.161 504.717L302.291 431.867Z"
                          fill="white"/>
                    ...
                    <Popup
                        ...
                        trigger={
                            <path id="Path_255"
                                  d="M528.976 868.543C452.146 868.714 377.227 844.604 314.917 799.656L276.67 851.586C350.206 904.648 438.601 933.169 529.282 933.093C619.963 933.017 708.31 904.348 781.757 851.163L743.457 799.233C681.082 844.418 605.997 868.682 528.976 868.543"
                                  fill={toetsorganisatie === "4" || toetsbekwaamheid === "0" ? "#ED7A0F" : "#909090"}/>
                        }
                    >
                        <div className='toetsmodel-component__element-hover orange'>
                            <h4>4. KETEN-GEORIËNTEERDE ONTWIKKELINGSFASE</h4>
                            <p>
                                Zowel de kwaliteitscriteria als de inrichting van de toetsorganisatie worden vastgesteld
                                met het werkveld. De rollen, taken en verantwoordelijkheden van het werkveld in de
                                toetsorganisatie zijn vastgelegd, evenals de toetsprocessen die plaatsvinden op de
                                werkplek. De kwaliteit van de toetsorganisatie wordt structureel geëvalueerd aan de hand
                                van de kwaliteitscriteria, de opbrengsten worden besproken met zowel de relevante
                                partners binnen de opleiding als het werkveld.
                            </p>
                        </div>
                    </Popup>
                    ...
                    <g id="Group_34" opacity="0.75">
                        <g id="Group_33">
                            <g id="Group 4">
                                <g id="Group_32">
                                    <mask id="mask3_0_1" style={{maskType: 'alpha'}} maskUnits="userSpaceOnUse" x="314"
                                          y="747" width="430" height="122">
                                        <path id="clip-path-6" d="M743.695 747.511H314.891V868.698H743.695V747.511Z"
                                              fill="white"/>
                                    </mask>
                                    <g mask="url(#mask3_0_1)">
                                        <g id="Group_4">
                                            ...
                                            <Popup
                                                ...
                                                trigger={
                                                    <path id="Path_256"
                                                          d="M528.95 804.195C465.906 804.28 404.42 784.604 353.139 747.933L314.891 799.863C377.402 844.716 452.421 868.805 529.359 868.729C606.297 868.653 681.268 844.416 743.691 799.44L705.447 747.511C653.986 784.393 592.259 804.217 528.947 804.195"
                                                          fill={toetsorganisatie === "3" || toetsbekwaamheid === "0" ? "#ED7A0F" : "#909090"}/>
                                                }
                                            >
                                                <div className='toetsmodel-component__element-hover orange'>
                                                    <h4>3. SYSTEEM-GEORIËNTEERDE ONTWIKKELINGSFASE</h4>
                                                    <p>
                                                        De kwaliteitscriteria die worden gebruikt bij het inrichten van
                                                        de toetsorganisatie worden met regelmaat bijgesteld op basis van
                                                        actuele (wetenschappelijke) inzichten. De rollen, taken en
                                                        verantwoordelijkheden worden binnen de opleiding regelmatig met
                                                        elkaar besproken en op elkaar afgestemd. De kwaliteit van de
                                                        toetsorganisatie wordt structureel geëvalueerd aan de hand van
                                                        de kwaliteitscriteria. De opbrengsten hiervan worden besproken
                                                        met relevante partners binnen de opleiding.
                                                    </p>
                                                </div>
                                            </Popup>
                    ...
                    <path id="Path_257"
                          d="M528.976 869.547C451.911 869.754 376.759 845.565 314.282 800.447L313.438 799.813L352.953 746.245L353.797 746.879C405.044 783.408 466.427 803.005 529.359 802.929C592.292 802.854 653.627 783.109 704.786 746.456L705.63 745.822L745.146 799.39L744.301 800.024C681.677 845.374 606.294 869.713 528.974 869.545M316.343 799.445C378.523 843.77 452.999 867.557 529.36 867.481C605.722 867.406 680.151 843.471 742.243 799.022L705.211 748.783C653.84 785.305 592.391 804.963 529.361 805.039C466.331 805.114 404.835 785.604 353.377 749.206L316.343 799.445Z"
                          fill="white"/>
                    <g id="Group_37" opacity="0.65">
                        <g id="Group_36">
                            <g id="Group 5">
                                <g id="Group_35">
                                    <mask id="mask4_0_1" style={{maskType: 'alpha'}} maskUnits="userSpaceOnUse" x="353"
                                          y="695" width="353" height="110">
                                        <path id="clip-path-7" d="M705.432 695.422H353.176V804.036H705.432V695.422Z"
                                              fill="white"/>
                                    </mask>
                                    <g mask="url(#mask4_0_1)">
                                        <g id="Group_5">
                                            ...
                                            <Popup
                                                ...
                                                trigger={
                                                    <path id="Path_258"
                                                          d="M528.987 739.692C479.678 739.801 431.573 724.468 391.423 695.845L353.176 747.774C404.603 784.444 466.209 804.118 529.372 804.042C592.534 803.966 654.092 784.144 705.432 747.351L667.185 695.422C626.879 724.263 578.547 739.745 528.985 739.692"
                                                          fill={toetsorganisatie === "2" || toetsbekwaamheid === "0" ? "#ED7A0F" : "#909090"}/>
                                                }
                                            >
                                                <div className='toetsmodel-component__element-hover orange'>
                                                    <h4>2. PROCES-GEORIËNTEERDE ONTWIKKELINGSFASE</h4>
                                                    <p>
                                                        Binnen de opleiding zijn kwaliteitscriteria vastgesteld voor de
                                                        toetsorganisatie. Alle rollen, taken en verantwoordelijkheden
                                                        zijn vastgelegd, zodat iedereen weet wie waarvoor
                                                        verantwoordelijk is. Het is voor iedereen helder hoe de
                                                        verschillende toetsprocessen zich tot elkaar (zouden moeten)
                                                        verhouden. De processen sluiten echter nog niet naadloos op
                                                        elkaar aan. Met enige regelmaat wordt de kwaliteit van de
                                                        toetsorganisatie geëvalueerd. De opbrengsten daarvan worden niet
                                                        vanzelfsprekend besproken met alle collega’s of studenten, maar
                                                        wel gebruikt om toetsprocessen te verbeteren.
                                                    </p>
                                                </div>
                                            </Popup>
                                        </g>
                    ...
                    <path id="Path_259"
                          d="M528.976 805.258C465.692 805.413 403.963 785.657 352.531 748.785L351.686 748.151L391.201 694.584L392.046 695.218C432.173 723.674 480.167 738.923 529.36 738.847C578.553 738.772 626.5 723.374 666.54 694.795L667.385 694.161L706.9 747.729L706.055 748.363C654.426 785.371 592.498 805.269 528.976 805.263M354.591 747.522C405.686 783.662 466.748 803.034 529.333 802.958C591.918 802.883 652.934 783.363 703.942 747.099L666.91 696.86C626.673 725.32 578.618 740.638 529.334 740.714C480.049 740.79 431.947 725.62 391.624 697.283L354.591 747.522Z"
                          fill="white"/>
                    <g id="Group_40" opacity="0.5">
                        <g id="Group_39">
                            <g id="Group 6">
                                <g id="Group_38">
                                    <mask id="mask5_0_1" style={{maskType: 'alpha'}} maskUnits="userSpaceOnUse" x="391"
                                          y="508" width="276" height="232">
                                        <path id="clip-path-8" d="M666.936 508.223H391.227V739.662H666.936V508.223Z"
                                              fill="white"/>
                                    </mask>
                                    <g mask="url(#mask5_0_1)">
                                        <g id="Group_6">
                                            ...
                                            <Popup
                                                ...
                                                trigger={
                                                    <path id="Path_260"
                                                          d="M391.227 695.815C431.526 724.411 479.735 739.736 529.149 739.661C578.563 739.585 626.724 724.111 666.936 695.392L529.161 508.223L391.227 695.815Z"
                                                          fill={toetsorganisatie === "1" || toetsbekwaamheid === "0" ? "#ED7A0F" : "#909090"}/>
                                                }
                                            >
                                                <div className='toetsmodel-component__element-hover orange'>
                                                    <h4>1. ACTIVITEITEN-GEORIËNTEERDE ONTWIKKELINGSFASE</h4>
                                                    <p>
                                                        Binnen de opleiding is niet vastgesteld aan welke
                                                        kwaliteitscriteria de toetsorganisatie moet voldoen. De
                                                        toetsprocessen worden door de docenten naar eigen inzicht
                                                        vormgegeven. Er zijn wel afspraken gemaakt over de rollen, taken
                                                        en verantwoordelijkheden binnen de toetsprocessen, maar
                                                        medewerkers weten uitsluitend aan welke verantwoordelijkheden
                                                        zij zelf moeten voldoen. De kwaliteit van de toetsorganisatie
                                                        wordt uitsluitend geëvalueerd als daar aanleiding toe is.
                                                    </p>
                                                </div>
                                            </Popup>
                    ...
                    <path id="Path_261"
                          d="M528.976 740.702C479.462 740.772 431.163 725.368 390.831 696.644L389.986 696.01L390.62 695.165L529.399 506.302L668.599 695.584L667.754 696.218C627.28 725.183 578.747 740.74 528.976 740.702M392.839 695.64C432.8 723.718 480.467 738.749 529.306 738.673C578.145 738.598 625.766 723.419 665.639 695.217L529.339 509.897L392.839 695.64Z"
                          fill="white"/>
                    ...
                    <Popup
                        ...
                        trigger={
                            <path id="Path_262"
                                  d="M960.41 501.601C960.406 456.889 953.491 412.447 939.91 369.848L878.683 390.134C901.916 463.477 901.562 542.26 877.673 615.392C853.783 688.524 807.56 752.322 745.51 797.807L783.176 850.159C838.138 810.177 882.851 757.75 913.656 697.166C944.462 636.583 960.483 569.566 960.41 501.601"
                                  fill={toetsbeleid === "4" || toetsbekwaamheid === "0" ? "#AF72AD" : "#909090"}/>
                        }
                    >
                        <div className='toetsmodel-component__element-hover purple'>
                            <h4>4. KETEN-GEORIËNTEERDE ONTWIKKELINGSFASE</h4>
                            <p>
                                De kwaliteitscriteria die gesteld worden aan het toets(beleids)plan worden besproken met
                                relevante in- en/of externe partners en sluiten aan bij de landelijke kaders. De
                                opgenomen processen en interventies richten zich op de lange termijn. Er zijn
                                tussendoelen opgesteld zodat tussentijdse evaluatie mogelijk is. Het beleidsplan wordt
                                structureel geëvalueerd aan de hand van de kwaliteitscriteria, de opbrengsten worden
                                besproken met zowel de relevante partners binnen de opleiding als het werkveld.
                            </p>
                        </div>
                    </Popup>
                    ...
                    <g id="Group_43" opacity="0.75">
                        <g id="Group_42">
                            <g id="Group 7">
                                <g id="Group_41">
                                    <mask id="mask6_0_1" style={{maskType: 'alpha'}} maskUnits="userSpaceOnUse" x="707"
                                          y="390" width="189" height="408">
                                        <path id="clip-path-9" d="M895.91 390.134H707.896V797.807H895.91V390.134Z"
                                              fill="white"/>
                                    </mask>
                                    <g mask="url(#mask6_0_1)">
                                        <g id="Group_7">
                                            ...
                                            <Popup
                                                ...
                                                trigger={
                                                    <path id="Path_263"
                                                          d="M831.355 501.601C831.395 549.091 820.236 595.921 798.785 638.29C777.334 680.659 746.195 717.374 707.896 745.454L745.562 797.806C807.623 752.33 853.855 688.533 877.746 615.398C901.638 542.264 901.986 463.477 878.742 390.134L817.515 410.42C826.781 439.923 831.449 470.677 831.355 501.601"
                                                          fill={toetsbeleid === "3" || toetsbekwaamheid === "0" ? "#AF72AD" : "#909090"}/>
                                                }
                                            >
                                                <div className='toetsmodel-component__element-hover purple'>
                                                    <h4>3. SYSTEEM-GEORIËNTEERDE ONTWIKKELINGSFASE</h4>
                                                    <p>
                                                        ...
                                                        van het toets(beleids)plan worden met regelmaat bijgesteld op
                                                        basis van actuele (wetenschappelijke) inzichten. Ook bij de
                                                        uitwerking van de processen en interventies wordt gebruik
                                                        gemaakt van actuele (wetenschappelijke) kennis. Het beleidsplan,
                                                        de visie op onderwijs en het toetskader van de instelling
                                                        sluiten naadloos op elkaar aan. Het beleidsplan wordt
                                    ...
                                    <g mask="url(#mask7_0_1)">
                                        <g id="Group_8">
                                            ...
                                            <Popup
                                                ...
                                                trigger={
                                                    <path id="Path_265"
                                                          d="M766.827 501.576C766.848 538.805 758.119 575.518 741.345 608.755C724.571 641.991 700.22 670.82 670.258 692.918L707.924 745.27C758.884 707.899 796.847 655.493 816.472 595.424C836.097 535.354 836.398 470.644 817.331 410.395L756.103 430.681C763.226 453.639 766.841 477.542 766.827 501.581"
                                                          fill={toetsbeleid === "2" || toetsbekwaamheid === "0" ? "#AF72AD" : "#909090"}/>
                                                }
                                            >
                                                <div className='toetsmodel-component__element-hover purple'>
                                                    <h4>2. PROCES-GEORIËNTEERDE ONTWIKKELINGSFASE</h4>
                                                    <p>
                                                        ...
                                                        toets(beleids)plan. De visie op onderwijs en het toetskader van
                                                        de instelling vormen de basis voor het beleidsplan. In het
                                                        beleidsplan zijn naast toetsprocessen ook interventies opgenomen
                                                        die beschrijven hoe de ambities gerealiseerd gaan worden. Met
                                                        enige regelmaat wordt zowel de kwaliteit als de uitvoerbaarheid
                                                        en bruikbaarheid van het beleidsplan geëvalueerd. De opbrengsten
                                                        daarvan worden niet vanzelfsprekend besproken met alle collega’s
                                                        of studenten, maar wel gebruikt om het beleidsplan bij te
                                                        stellen.
                                                    </p>
                                                </div>
                                            </Popup>
                    ...
                    <g id="Group_49" opacity="0.65">
                        <g id="Group_48">
                            <g id="Group 9">
                                <g id="Group_47">
                                    <mask id="mask8_0_1" style={{maskType: 'alpha'}} maskUnits="userSpaceOnUse" x="668"
                                          y="409" width="165" height="338">
                                        <path id="clip-path-11" d="M832.79 409.16H668.971V746.941H832.79V409.16Z"
                                              fill="white"/>
                                    </mask>
                                    <g mask="url(#mask8_0_1)">
                                        <g id="Group_9">
                                            <path id="Path_266"
                                                  d="M707.852 746.888L668.971 692.687L669.816 692.053C699.571 669.978 723.762 641.262 740.463 608.19C757.164 575.117 765.914 538.603 766.016 501.553C766.09 477.629 762.454 453.839 755.239 431.028L755.028 429.971L818.315 409.107L818.738 410.164C837.874 470.635 837.571 535.583 817.869 595.871C798.168 656.16 760.061 708.754 708.909 746.255L707.852 746.888ZM671.877 693.107L708.277 743.769C758.704 706.594 796.272 654.608 815.742 595.061C835.212 535.514 835.613 471.376 816.889 411.59L757.51 431.242C764.524 453.948 768.086 477.578 768.076 501.342C768.007 538.577 759.28 575.285 742.585 608.566C725.889 641.848 701.682 670.791 671.877 693.107"
                                                  fill="white"/>
                                        </g>
                                    </g>
                                </g>
                    ...
                    <g id="Group_52" opacity="0.5">
                        <g id="Group_51">
                            <g id="Group 10">
                                <g id="Group_50">
                                    <mask id="mask9_0_1" style={{maskType: 'alpha'}} maskUnits="userSpaceOnUse" x="534"
                                          y="430" width="234" height="263">
                                        <path id="clip-path-12" d="M767.042 430.833H534.969V692.912H767.042V430.833Z"
                                              fill="white"/>
                                    </mask>
                                    <g mask="url(#mask9_0_1)">
                                        <g id="Group_10">
                                            ...
                                            <Popup
                                                ...
                                                trigger={
                                                    <path id="Path_267"
                                                          d="M670.416 692.912C700.366 670.803 724.707 641.971 741.479 608.737C758.252 575.503 766.989 538.796 766.985 501.569C767.036 477.578 763.404 453.722 756.216 430.833L534.916 504.264L670.416 692.912Z"
                                                          fill={toetsbeleid === "1" || toetsbekwaamheid === "0" ? "#AF72AD" : "#909090"}/>
                                                }
                                            >
                                                <div className='toetsmodel-component__element-hover purple'>
                                                    <h4>1. ACTIVITEITEN-GEORIËNTEERDE ONTWIKKELINGSFASE</h4>
                                                    <p>
                                                        Binnen de opleiding is niet vastgesteld aan welke
                                                        kwaliteitseisen een toets(beleids)plan moet voldoen. Het
                                                        beleidsplan is hoofdzakelijk een beschrijving van (losse)
                                                        toetsprocessen, deze sluiten nog niet (volledig) aan op de visie
                                                        op onderwijs. De kwaliteit van het beleidsplan wordt uitsluitend
                                                        geëvalueerd als daar aanleiding toe is.
                                                    </p>
                                                </div>
                                            </Popup>
                    ...
                    <g id="Group_55" opacity="0.5">
                        <g id="Group_54">
                            <g id="Group 11">
                                <g id="Group_53">
                                    <mask id="mask10_0_1" style={{maskType: 'alpha'}} maskUnits="userSpaceOnUse" x="533"
                                          y="429" width="236" height="266">
                                        <path id="clip-path-13" d="M768.089 429.42H533.322V694.405H768.089V429.42Z"
                                              fill="white"/>
                                    </mask>
                                    <g mask="url(#mask10_0_1)">
                                        <g id="Group_11">
                                            <path id="Path_268"
                                                  d="M670.252 694.352L533.322 503.432L756.89 429.367L757.313 430.424C772.048 477.831 771.665 528.648 756.216 575.827C740.767 623.006 711.019 664.208 671.098 693.718L670.252 694.352ZM536.597 504.7L670.622 691.499C709.787 662.289 738.973 621.693 754.187 575.264C769.402 528.835 769.903 478.839 755.622 432.114L536.597 504.7Z"
                                                  fill="white"/>
                                        </g>
                                    </g>
                                </g>
                    ...
                    <Popup
                        ...
                        trigger={
                            <path id="Path_269"
                                  d="M877.898 387.651L939.338 367.999C883.286 195.516 721.317 70.5783 530.186 69.9443L530.609 134.5C692.791 135.292 830.142 241.159 877.898 387.651Z"
                                  fill={toetsprogramma === "4" || toetsbekwaamheid === "0" ? "#2DB3A5" : "#909090"}/>
                        }
                    >
                        <div className='toetsmodel-component__element-hover turquoise'>
                            <h4>4. KETEN-GEORIËNTEERDE ONTWIKKELINGSFASE</h4>
                            <p>
                                Zowel de kwaliteitscriteria als de opbouw van het toetsprogramma worden vastgesteld met
                                het werkveld. Programmaonderdelen die plaatsvinden op de werkplek worden afgestemd met
                                het werkveld zodat deze uitvoerbaar en passend zijn. Het toetsprogramma wordt
                                structureel geëvalueerd aan de hand van de kwaliteitscriteria. De opbrengsten worden
                                besproken met zowel de relevante partners binnen de opleiding als het werkveld.
                            </p>
                        </div>
                    ...
                    <g id="Group_58" opacity="0.75">
                        <g id="Group_57">
                            <g id="Group 12">
                                <g id="Group_56">
                                    <mask id="mask11_0_1" style={{maskType: 'alpha'}} maskUnits="userSpaceOnUse" x="530"
                                          y="134" width="348" height="274">
                                        <path id="clip-path-14" d="M877.913 134.467H530.623V407.27H877.913V134.467Z"
                                              fill="white"/>
                                    </mask>
                                    <g mask="url(#mask11_0_1)">
                                        <g id="Group_12">
                                            ...
                                            <Popup
                                                ...
                                                trigger={
                                                    <path id="Path_270"
                                                          d="M816.475 407.267L877.914 387.615C830.104 241.179 692.752 135.259 530.623 134.467L531.046 199.023C594.432 199.494 656.071 219.844 707.278 257.204C758.485 294.564 796.678 347.05 816.475 407.267Z"
                                                          fill={toetsprogramma === "3" || toetsbekwaamheid === "0" ? "#2DB3A5" : "#909090"}/>
                                                }
                                            >
                                                <div className='toetsmodel-component__element-hover turquoise'>
                                                    <h4>3. SYSTEEM-GEORIËNTEERDE ONTWIKKELINGSFASE</h4>
                    ...
                    <path id="Path_271"
                          d="M815.825 408.518L815.402 407.461C795.78 347.396 757.746 295.033 706.695 257.797C655.643 220.561 594.165 200.341 530.977 200.006H529.92L529.498 133.39H530.555C607.931 133.658 683.25 158.332 745.786 203.899C808.322 249.466 854.886 313.602 878.849 387.175L879.272 388.232L815.825 408.518ZM532.087 197.946C595.346 198.514 656.842 218.864 707.953 256.144C759.063 293.423 797.227 345.762 817.093 405.824L876.683 386.806C852.766 314.026 806.596 250.596 744.691 205.468C682.786 160.339 608.271 135.792 531.664 135.29L532.087 197.946Z"
                          fill="white"/>
                    <g id="Group_61" opacity="0.65">
                        <g id="Group_60">
                            <g id="Group 13">
                                <g id="Group_59">
                                    <mask id="mask12_0_1" style={{maskType: 'alpha'}} maskUnits="userSpaceOnUse" x="531"
                                          y="199" width="286" height="228">
                                        <path id="clip-path-15" d="M816.464 199.001H531.035V426.742H816.464V199.001Z"
                                              fill="white"/>
                                    </mask>
                                    <g mask="url(#mask12_0_1)">
                                        <g id="Group_13">
                                            ...
                                            <Popup
                                                ...
                                                trigger={
                                                    <path id="Path_272"
                                                          d="M531.035 199.001L531.458 263.557C581.085 264.052 629.316 280.048 669.403 309.308C709.49 338.568 739.427 379.627 755.025 426.742L816.464 407.09C796.631 346.909 758.424 294.462 707.221 257.133C656.019 219.805 594.399 199.473 531.035 199.001"
                                                          fill={toetsprogramma === "2" || toetsbekwaamheid === "0" ? "#2DB3A5" : "#909090"}/>
                                                }
                                            >
                                                <div className='toetsmodel-component__element-hover turquoise'>
                                                    <h4>2. PROCES-GEORIËNTEERDE ONTWIKKELINGSFASE</h4>
                                    ...
                                    <g mask="url(#mask13_0_1)">
                                        <g id="Group_14">
                                            ...
                                            <Popup
                                                ...
                                                trigger={
                                                    <path id="Path_274"
                                                          d="M755.013 426.952C739.425 379.831 709.49 338.765 669.401 309.503C629.312 280.242 581.075 264.25 531.445 263.767L532.871 497.689L755.013 426.952Z"
                                                          fill={toetsprogramma === "1" || toetsbekwaamheid === "0" ? "#2DB3A5" : "#909090"}/>
                                                }
                                            >
                                                <div className='toetsmodel-component__element-hover turquoise'>
                                                    <h4>1. ACTIVITEITEN-GEORIËNTEERDE ONTWIKKELINGSFASE</h4>
                                                    <p>
                                                        Binnen de opleiding is niet vastgesteld aan welke
                                                        kwaliteitscriteria het toetsprogramma van de opleiding moet
                                                        voldoen. Iedere docent ontwikkelt zijn eigen toetsen, er is
                                                        echter geen overzicht van de samenhang tussen de toetsen. Het is
                                                        hierdoor niet met zekerheid vast te stellen dat de toetsen
                                                        gezamenlijk de beoogde leerresultaten dekken.
                                                    </p>
                                                </div>
                                            </Popup>
                    ...
                    <path id="Path_275"
                          d="M531.664 498.902L530.449 262.502H531.506C581.373 263.021 629.831 279.11 670.105 308.521C710.379 337.931 740.456 379.191 756.13 426.533L756.553 427.59L755.496 428.013L531.664 498.902ZM532.456 264.558L533.882 495.997L753.752 426.106C738.102 379.598 708.415 339.088 668.781 310.156C629.147 281.223 581.517 265.292 532.452 264.558"
                          fill="white"/>
                    ...
                    <Popup
                        ...
                        trigger={
                            <path id="Path_276"
                                  d="M528.129 134.447L528.552 69.8906C336.997 70.1016 174.869 195.04 118.607 367.735L180.046 387.391C227.807 241 365.577 134.869 528.129 134.447Z"
                                  fill={toetstaken === "4" || toetsbekwaamheid === "0" ? "#45A7C3" : "#909090"}/>
                        }
                    >
                        <div className='toetsmodel-component__element-hover blue'>
                            <h4>4. KETEN-GEORIËNTEERDE ONTWIKKELINGSFASE</h4>
                            <p>
                                Zowel kwaliteitscriteria voor de toetsen als de leer- en toetsdoelen zijn afgestemd met
                                het werkveld. De toetsen sluiten hierdoor niet alleen aan bij het onderwijs dat de
                                student volgt binnen de opleiding, maar ook op wat geleerd wordt op de werkplek. Toetsen
                                worden structureel geëvalueerd aan de hand van de kwaliteitscriteria. De opbrengsten
                    ...
                    <g id="Group_67" opacity="0.75">
                        <g id="Group_66">
                            <g id="Group 15">
                                <g id="Group_65">
                                    <mask id="mask14_0_1" style={{maskType: 'alpha'}} maskUnits="userSpaceOnUse" x="180"
                                          y="134" width="349" height="274">
                                        <path id="clip-path-17" d="M528.15 134.467H180.014V407.059H528.15V134.467Z"
                                              fill="white"/>
                                    </mask>
                                    <g mask="url(#mask14_0_1)">
                                        <g id="Group_15">
                                            ...
                                            <Popup
                                                ...
                                                trigger={
                                                    <path id="Path_277"
                                                          d="M527.727 198.97L528.15 134.414C365.599 134.837 228.035 240.756 180.014 387.407L241.453 407.059C261.32 346.734 299.652 294.183 351.026 256.84C402.4 219.497 464.215 199.252 527.727 198.97"
                                                          fill={toetstaken === "3" || toetsbekwaamheid === "0" ? "#45A7C3" : "#909090"}/>
                                                }
                                            >
                                                <div className='toetsmodel-component__element-hover blue'>
                                                    <h4>3. SYSTEEM-GEORIËNTEERDE ONTWIKKELINGSFASE</h4>
                                                    <p>
                                                        De kwaliteitscriteria die docenten gebruiken bij het ontwikkelen
                                                        van toetsen worden met regelmaat bijgesteld op basis van actuele
                                                        (wetenschappelijke) inzichten. De toetsen, die ontwikkeld worden
                                                        voorafgaand aan het onderwijs, zijn passend voor de
                                                        leerresultaten en sluiten aan bij eerder gegeven onderwijs. De
                                                        kwaliteit van toetsen wordt structureel geëvalueerd aan de hand
                                                        van de kwaliteitscriteria. De opbrengsten hiervan worden
                                                        besproken met relevante partners binnen de opleiding.
                                                    </p>
                                                </div>
                                            </Popup>
                    ...
                    <g id="Group_70" opacity="0.65">
                        <g id="Group_69">
                            <g id="Group 16">
                                <g id="Group_68">
                                    <mask id="mask15_0_1" style={{maskType: 'alpha'}} maskUnits="userSpaceOnUse" x="241"
                                          y="199" width="287" height="228">
                                        <path id="clip-path-18" d="M527.71 199.001H241.436V426.531H527.71V199.001Z"
                                              fill="white"/>
                                    </mask>
                                    <g mask="url(#mask15_0_1)">
                                        <g id="Group_16">
                                            ...
                                            <Popup
                                                ...
                                                trigger={
                                                    <path id="Path_279"
                                                          d="M527.34 263.504L527.763 198.948C464.279 199.22 402.484 219.435 351.114 256.737C299.744 294.04 261.395 346.543 241.488 406.826L302.927 426.478C318.649 379.292 348.74 338.208 388.983 308.982C429.226 279.756 477.605 263.854 527.34 263.504"
                                                          fill={toetstaken === "2" || toetsbekwaamheid === "0" ? "#45A7C3" : "#909090"}/>
                                                }
                                            >
                                                <div className='toetsmodel-component__element-hover blue'>
                                                    <h4>2. PROCES-GEORIËNTEERDE ONTWIKKELINGSFASE</h4>
                                                    <p>
                                                        Docenten ontwikkelen toetsen aan de hand van een toetscyclus of
                                                        ontwerpproces en maken daarbij gebruik van kwaliteitscriteria
                                                        die zijn gebaseerd op ervaringen van ervaren toetsontwikkelaars.
                                                        De toetsen, die worden ontwikkeld tijdens de onderwijsperiode,
                                                        maken zij samen met collega’s. De kwaliteit van de toetsen wordt
                                                        door de betrokken docenten regelmatig geëvalueerd. De
                                                        opbrengsten daarvan worden niet vanzelfsprekend besproken met
                                                        collega’s of studenten, maar wel gebruikt om eigen toetsen te
                                                        verbeteren.
                                                    </p>
                                                </div>
                                            </Popup>
                    ...
                    <path id="Path_280"
                          d="M303.506 427.958L240.006 407.672L240.429 406.615C260.315 346.085 298.749 293.351 350.283 255.889C401.817 218.426 463.836 198.135 527.548 197.893H528.606L528.183 264.509H527.126C477.59 264.848 429.405 280.693 389.336 309.819C349.266 338.945 319.325 379.888 303.716 426.902L303.506 427.958ZM242.706 406.458L302.296 425.476C318.11 378.448 348.172 337.51 388.309 308.344C428.446 279.177 476.667 263.229 526.28 262.713L526.703 200.27C463.74 200.587 402.464 220.656 351.513 257.647C300.561 294.639 262.503 346.687 242.703 406.457"
                          fill="white"/>
                    <g id="Group_73" opacity="0.5">
                        <g id="Group_72">
                            <g id="Group 17">
                                <g id="Group_71">
                                    <mask id="mask16_0_1" style={{maskType: 'alpha'}} maskUnits="userSpaceOnUse" x="302"
                                          y="263" width="226" height="235">
                                        <path id="clip-path-19" d="M527.325 263.534H302.912V497.456H527.325V263.534Z"
                                              fill="white"/>
                                    </mask>
                                    <g mask="url(#mask16_0_1)">
                                        <g id="Group_17">
                                            ...
                                            <Popup
                                                ...
                                                trigger={
                                                    <path id="Path_281"
                                                          d="M527.325 263.534C422.884 264.168 334.345 332.422 302.912 426.508L525.898 497.456L527.325 263.534Z"
                                                          fill={toetstaken === "1" || toetsbekwaamheid === "0" ? "#46A8C4" : "#909090"}/>
                                                }
                                            >
                                                <div className='toetsmodel-component__element-hover blue'>
                                                    <h4>1. ACTIVITEITEN-GEORIËNTEERDE ONTWIKKELINGSFASE</h4>
                                                    <p>
                                                        Docenten ontwikkelen toetsen naar eigen inzicht: zij gebruiken
                                                        eigen kwaliteitscriteria, ontwerpen de toets vaak alleen en kort
                                                        voor de afname. De kwaliteit van de toetsen wordt uitsluitend
                                                        geëvalueerd als daar aanleiding toe is.
                                                    </p>
                                                </div>
                                            </Popup>
                    ...
                    <path id="Path_282"
                          d="M526.916 498.907L301.658 427.114L302.081 426.057C317.835 378.658 348.025 337.376 388.421 307.999C428.816 278.621 477.392 262.62 527.339 262.238H528.396L526.916 498.907ZM304.352 425.899L525.067 496.213L526.493 264.774C477.299 265.16 429.453 280.892 389.63 309.777C349.807 338.661 319.995 379.257 304.352 425.899"
                          fill="white"/>
                    ...
                    >
                        <div className='toetsmodel-component__hover'>
                            ...
                            <p className='toetsmodel-component__center--read-more' onClick={() => setOpen(true)}>Lees
                                meer...</p>
                        </div>
                    </Popup>
                    ...
                    <Popup
                        ...
                        trigger={
                            <g id="blue-1">
                                <path id="Blue_-_1-2"
                                      d="M399.019 371.909C412.149 371.909 422.792 361.266 422.792 348.136C422.792 335.007 412.149 324.363 399.019 324.363C385.89 324.363 375.246 335.007 375.246 348.136C375.246 361.266 385.89 371.909 399.019 371.909Z"
                                      fill={toetstaken === "1" || toetsbekwaamheid === "0" ? "#A2D3E1" : "#c7c7c7"}/>
                                <path id="Blue_-_1"
                                      d="M391.41 361.977V357.222H397.01V342.322H392.255V338.622C393.476 338.424 394.665 338.068 395.794 337.565C396.788 337.143 397.758 336.667 398.7 336.139H403.032V357.006H407.787V361.761H391.463V361.972L391.41 361.977Z"
                                      fill="#020304"/>
                            </g>
                        }
                    >
                        <div className='toetsmodel-component__one-hover'>
                            ...
                            <p>
                                ...
                                examencommissie, toetsexperts/toetscommissie, ondersteunende medewerkers) voeren ad hoc
                                op onderdelen toetsactiviteiten uit waarbij geen aandacht is voor de onderlinge
                    ...
                    >
                        <div className='toetsmodel-component__one-hover'>
                            ...
                            <p>
                                Relevante medewerkers in de opleiding (docenten/examinatoren, opleidingsmanagement,
                                examencommissie, toetsexperts/toetscommissie, ondersteunende medewerkers) voeren vanuit
                                een korte termijn perspectief procesmatig toetsactiviteiten uit die onderling
                                samenhangen.
                            </p>
                        </div>
                    </Popup>
                    ...
                    >
                        <div className='toetsmodel-component__one-hover'>
                            ...
                            <p>
                                Alle relevante medewerkers en partners in de opleiding (studenten,
                                docenten/examinatoren, opleidingsmanagement, examencommissie,
                                toetsexperts/toetscommissie, ondersteunende medewerkers) voeren gezamenlijk vanuit een
                                middellange termijn perspectief volgens de PDCA-cyclus toetsactiviteiten uit die zijn
                                geïntegreerd in lopende processen binnen de opleiding.
                            </p>
                        </div>
                    </Popup>
                    ...
                    <Popup
                        ...
                        trigger={
                            <g id="blue-4">
                                <path id="Blue_-_4-2"
                                      d="M258.074 231.123C271.203 231.123 281.847 220.48 281.847 207.35C281.847 194.221 271.203 183.577 258.074 183.577C244.944 183.577 234.301 194.221 234.301 207.35C234.301 220.48 244.944 231.123 258.074 231.123Z"
                                      fill={toetstaken === "4" || toetsbekwaamheid === "0" ? "#45A7C3" : "#909090"}/>
                                <path id="Blue_-_4"
                                      d="M257.811 219.236V213.055H246.664V208.934L255.964 193.403H263.201V208.303H266.107V212.846H263.201V219.027H257.813L257.811 219.236ZM252.423 208.723H257.811V201.697C257.811 200.64 258.022 199.637 258.022 198.791H257.811C257.388 199.425 257.177 200.217 256.754 200.851C256.331 201.696 256.12 202.277 255.697 203.123L252.423 208.723Z"
                                      fill="#020304"/>
                            </g>
                        }
                    >
                        <div className='toetsmodel-component__one-hover'>
                            ...
                            <p>
                                Alle relevante medewerkers en partners binnen de opleiding en in de keten (studenten,
                                docenten/examinatoren, opleidingsmanagement, examencommissie,
                                toetsexperts/toetscommissie, ondersteunende medewerkers, werkveld en externe
                                deskundigen) voeren gezamenlijk vanuit een lange termijn perspectief volgens de
                                PDCA-cyclus gezamenlijk toetsactiviteiten uit die zijn geïntegreerd in lopende processen
                                binnen de opleiding en de keten.
                            </p>
                        </div>
                    </Popup>
                    ...
                    <Popup
                        ...
                        trigger={
                            <g id="purple-1">
                                <path id="Paars_-_1-2"
                                      d="M720.628 587.447C733.758 587.447 744.401 576.804 744.401 563.674C744.401 550.545 733.758 539.901 720.628 539.901C707.499 539.901 696.855 550.545 696.855 563.674C696.855 576.804 707.499 587.447 720.628 587.447Z"
                                      fill={toetsbeleid === "1" || toetsbekwaamheid === "0" ? "#D7B8D6" : "c7c7c7"}/>
                                <path id="Paars_-_1"
                                      d="M712.229 575.877V571.123H717.828V556.223H713.074V552.523C714.295 552.325 715.484 551.97 716.614 551.466C717.608 551.044 718.578 550.568 719.52 550.04H723.851V570.907H728.606V575.662H712.282V575.873L712.229 575.877Z"
                                      fill="#020304"/>
                            </g>
                        }
                    >
                    ...
                    <Popup
                        ...
                        trigger={
                            <g id="purple-4">
                                <path id="Paars_-_4-2"
                                      d="M889.941 695.955C903.07 695.955 913.714 685.312 913.714 672.182C913.714 659.053 903.07 648.409 889.941 648.409C876.812 648.409 866.168 659.053 866.168 672.182C866.168 685.312 876.812 695.955 889.941 695.955Z"
                                      fill={toetsbeleid === "4" || toetsbekwaamheid === "0" ? "#AF72AD" : "#909090"}/>
                                <path id="Paars_-_4"
                                      d="M893.639 686.076V679.895H882.492V675.774L891.792 660.243H899.029V675.143H901.935V679.686H899.029V685.867H893.641L893.639 686.076ZM888.25 675.352H893.638V668.326C893.638 667.269 893.849 666.266 893.849 665.42H893.638C893.215 666.054 893.004 666.846 892.581 667.48C892.158 668.325 891.947 668.906 891.524 669.752L888.25 675.352Z"
                                      fill="#020304"/>
                            </g>
                        }
                    >
                    ...
                    <Popup
                        ...
                        trigger={
                            <g id="green-1">
                                <path id="Groen_-_1c"
                                      d="M336.259 587.975C349.389 587.975 360.032 577.331 360.032 564.202C360.032 551.072 349.389 540.429 336.259 540.429C323.13 540.429 312.486 551.072 312.486 564.202C312.486 577.331 323.13 587.975 336.259 587.975Z"
                                      fill={toetsbekwaamheid === "1" || toetsbekwaamheid === "0" ? "#A2D6A3" : "#c7c7c7"}/>
                                <path id="Green_-_1"
                                      d="M327.912 575.877V571.123H333.512V556.223H328.757V552.523C329.978 552.325 331.168 551.97 332.297 551.466C333.291 551.044 334.261 550.568 335.203 550.04H339.535V570.907H344.29V575.662H327.965V575.873L327.912 575.877Z"
                                      fill="#020304"/>
                            </g>
                        }
                    >
                    ...
                    <Popup
                        ...
                        trigger={
                            <g id="green-4">
                                <path id="Groen_-_4c"
                                      d="M159.443 673.767C172.572 673.767 183.216 663.123 183.216 649.994C183.216 636.864 172.572 626.221 159.443 626.221C146.313 626.221 135.67 636.864 135.67 649.994C135.67 663.123 146.313 673.767 159.443 673.767Z"
                                      fill={toetsbekwaamheid === "4" || toetsbekwaamheid === "0" ? "#46AD48" : "#909090"}/>
                                <path id="Green_-_4"
                                      d="M159.76 661.669V655.488H148.613V651.367L157.913 635.836H165.15V650.736H168.056V655.279H165.15V661.46H159.762L159.76 661.669ZM154.372 650.945H159.76V643.919C159.76 642.862 159.971 641.859 159.971 641.013H159.76C159.337 641.647 159.126 642.439 158.703 643.073C158.28 643.918 158.069 644.499 157.646 645.344L154.372 650.945Z"
                                      fill="#020304"/>
                            </g>
                        }
                    >
                    ...
                    <Popup
                        ...
                        trigger={
                            <g id="orange-1">
                                <path id="Oranje_-_1-2"
                                      d="M530.134 733.357C543.264 733.357 553.907 722.713 553.907 709.584C553.907 696.454 543.264 685.811 530.134 685.811C517.005 685.811 506.361 696.454 506.361 709.584C506.361 722.713 517.005 733.357 530.134 733.357Z"
                                      fill={toetsorganisatie === "1" || toetsbekwaamheid === "0" ? "#F6BC87" : "#c7c7c7"}/>
                                <path id="Oranje_-_1"
                                      d="M522.156 721.893V717.138H527.756V702.238H523.001V698.538C524.222 698.34 525.412 697.984 526.541 697.481C527.535 697.059 528.505 696.583 529.447 696.055H533.779V716.922H538.534V721.676H522.21V721.887L522.156 721.893Z"
                                      fill="#020304"/>
                            </g>
                        }
                    >
                    ...
                    <Popup
                        ...
                        trigger={
                            <g id="orange-4">
                                <path id="Oranje_-_4-2"
                                      d="M531.191 925.598C544.32 925.598 554.964 914.954 554.964 901.825C554.964 888.695 544.32 878.052 531.191 878.052C518.062 878.052 507.418 888.695 507.418 901.825C507.418 914.954 518.062 925.598 531.191 925.598Z"
                                      fill={toetsorganisatie === "4" || toetsbekwaamheid === "0" ? "#ED7A0F" : "#909090"}/>
                                <path id="Oranje_-_4"
                                      d="M531.032 913.394V907.213H519.885V903.092L529.185 887.561H536.422V902.461H539.328V907.004H536.422V913.185H531.034L531.032 913.394ZM525.644 902.67H531.032V895.644C531.032 894.587 531.243 893.584 531.243 892.738H531.032C530.609 893.372 530.398 894.164 529.975 894.798C529.552 895.643 529.341 896.224 528.918 897.07L525.644 902.67Z"
                                      fill="#020304"/>
                            </g>
                        }
                    >
                    ...
                    <Popup
                        ...
                        trigger={
                            <g id="turqoise-1">
                                <path id="Turqoise_-_1-2"
                                      d="M662.728 369.268C675.858 369.268 686.501 358.624 686.501 345.495C686.501 332.365 675.858 321.722 662.728 321.722C649.599 321.722 638.955 332.365 638.955 345.495C638.955 358.624 649.599 369.268 662.728 369.268Z"
                                      fill={toetsprogramma === "1" || toetsbekwaamheid === "0" ? "#96D9D2" : "#c7c7c7"}/>
                                <path id="Turqoise_-_1"
                                      d="M654.488 361.977V357.222H660.088V342.322H655.334V338.622C656.555 338.424 657.744 338.068 658.873 337.565C659.867 337.143 660.837 336.667 661.779 336.139H666.111V357.006H670.865V361.761H654.541L654.488 361.977Z"
                                      fill="#020304"/>
                            </g>
                        }
                    >
                    ...
                    <Popup
                        ...
                        trigger={
                            <g id="turqoise-4">
                                <path id="Turqoise_-_4-2"
                                      d="M801.877 234.293C815.006 234.293 825.65 223.65 825.65 210.52C825.65 197.391 815.006 186.747 801.877 186.747C788.747 186.747 778.104 197.391 778.104 210.52C778.104 223.65 788.747 234.293 801.877 234.293Z"
                                      fill={toetsprogramma === "4" || toetsbekwaamheid === "0" ? "#2DB3A5" : "#909090"}/>
                                <path id="Turqoise_-_4"
                                      d="M802.827 222.775V216.594H791.68V212.473L800.98 196.942H808.217V211.787H811.123V216.33H808.217V222.511H802.829L802.827 222.775ZM797.438 211.998H802.826V204.972C802.826 203.915 803.037 202.912 803.037 202.066H802.826C802.403 202.7 802.192 203.492 801.769 204.126C801.346 204.971 801.135 205.552 800.712 206.398L797.438 211.998Z"
                                      fill="#020304"/>
                            </g>
                        }
                    >
                    ...
                    <path id="Path_389"
                          d="M525.643 328.061L527.281 63.71L531.824 63.499L532.669 328.853L525.643 328.061Z"
                          fill="white"/>
                    <path id="Path_390"
                          d="M692.787 446.184L944.301 364.459L945.939 368.58L694.214 452.946L692.787 446.184Z"
                          fill="white"/>
                    <path id="Path_391" d="M367.215 446.184L115.913 364.459L114.275 368.58L366 452.946L367.215 446.184Z"
                          fill="white"/>
                    <path id="Path_392"
                          d="M427.387 636.681L273.711 851.796L277.25 854.49L433.411 640.009L427.387 636.681Z"
                          fill="white"/>
                    <path id="Path_393"
                          d="M631.982 637.051L785.448 852.166L782.12 855.072L625.748 640.591L631.982 637.051Z"
                          fill="white"/>
                </g>
            </svg>
