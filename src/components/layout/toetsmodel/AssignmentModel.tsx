        ...
        <div className={"toetsmodel-component"}>
            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
                ...
                <g id="assessmenttasks">
                    <GenericEntity
                        phase={entities[Entities.ASSESSMENT_TASKS].elements[0].phases[Phases.ACTIVITY_ORIENTED]}
                        result={tasksResult}
                        d="M297.4,182.5c-50.5,0.3-93.3,33.3-108.5,78.8l107.8,34.3L297.4,182.5z"/>
                    <GenericEntity
                        phase={entities[Entities.ASSESSMENT_TASKS].elements[0].phases[Phases.PROCESS_ORIENTED]}
                        result={tasksResult}
                        d="M297.4,182.5l0.2-31.2c-64.6,0.3-119.2,42.3-138.4,100.5l29.7,9.5C204,215.8,246.8,182.9,297.4,182.5z"/>
                    <GenericEntity
                        phase={entities[Entities.ASSESSMENT_TASKS].elements[0].phases[Phases.SYSTEM_ORIENTED]}
                        result={tasksResult}
                        d="M297.6,151.3l0.2-31.2c-78.6,0.2-145.1,51.4-168.3,122.3l29.7,9.5C178.3,193.7,233,151.6,297.6,151.3z"/>
                    <GenericEntity phase={entities[Entities.ASSESSMENT_TASKS].elements[0].phases[Phases.CHAIN_ORIENTED]}
                                   result={tasksResult}
                ...
                <g id="assessmentprogram">
                    <GenericEntity
                        phase={entities[Entities.ASSESSMENT_PROGRAMME].elements[0].phases[Phases.ACTIVITY_ORIENTED]}
                        result={programmeResult}
                        d="M407.5,261.5c-15-45.5-57.7-78.4-108.1-78.9l0.7,113.1L407.5,261.5z"/>
                    <GenericEntity
                        phase={entities[Entities.ASSESSMENT_PROGRAMME].elements[0].phases[Phases.PROCESS_ORIENTED]}
                        result={programmeResult}
                        d="M299.2,151.3l0.2,31.2c50.4,0.5,93.1,33.4,108.1,78.9l29.7-9.5C418.1,193.8,363.6,151.8,299.2,151.3z"/>
                    <GenericEntity
                        phase={entities[Entities.ASSESSMENT_PROGRAMME].elements[0].phases[Phases.SYSTEM_ORIENTED]}
                        result={programmeResult}
                        d="M437.2,252l29.7-9.5c-23.1-70.8-89.5-122-167.9-122.4l0.2,31.2C363.6,151.8,418.1,193.8,437.2,252z"/>
                    <GenericEntity
                        phase={entities[Entities.ASSESSMENT_PROGRAMME].elements[0].phases[Phases.CHAIN_ORIENTED]}
                        result={programmeResult}
                ...
                <g id="assessmentpolicy">
                    <GenericEntity
                        phase={entities[Entities.ASSESSMENT_POLICY].elements[0].phases[Phases.ACTIVITY_ORIENTED]}
                        result={policyResult}
                        d="M366.6,390.1c28.3-21,46.7-54.6,46.7-92.5c0-11.9-1.8-23.4-5.2-34.2l-107,35.5L366.6,390.1z"/>
                    <GenericEntity
                        phase={entities[Entities.ASSESSMENT_POLICY].elements[0].phases[Phases.PROCESS_ORIENTED]}
                        result={policyResult}
                    ...
                    <GenericEntity
                        phase={entities[Entities.ASSESSMENT_POLICY].elements[0].phases[Phases.SYSTEM_ORIENTED]}
                        result={policyResult}
                    ...
                    <GenericEntity
                        phase={entities[Entities.ASSESSMENT_POLICY].elements[0].phases[Phases.CHAIN_ORIENTED]}
                        result={policyResult}
                ...
                <g id="assessmentorganisation">
                    <GenericEntity
                        phase={entities[Entities.ASSESSMENT_ORGANISATION].elements[0].phases[Phases.ACTIVITY_ORIENTED]}
                        result={organisationResult}
                        d="M231.6,391.5c18.8,13.3,41.7,21.2,66.5,21.2c24.9,0,48-7.9,66.8-21.4l-66.6-90.5L231.6,391.5z"/>
                    <GenericEntity
                        phase={entities[Entities.ASSESSMENT_ORGANISATION].elements[0].phases[Phases.PROCESS_ORIENTED]}
                        result={organisationResult}
                    ...
                    <GenericEntity
                        phase={entities[Entities.ASSESSMENT_ORGANISATION].elements[0].phases[Phases.SYSTEM_ORIENTED]}
                        result={organisationResult}
                    ...
                    <GenericEntity
                        phase={entities[Entities.ASSESSMENT_ORGANISATION].elements[0].phases[Phases.CHAIN_ORIENTED]}
                        result={organisationResult}
                ...
                <g id="assessmentliteracy">
                    <GenericEntity
                        phase={entities[Entities.ASSESSMENT_LITERACY].elements[0].phases[Phases.ACTIVITY_ORIENTED]}
                        result={literacyResult}
                        d="M188.3,263.2c-3.4,10.9-5.2,22.4-5.2,34.4c0,38.1,18.5,71.8,46.9,92.7l65.7-91.5L188.3,263.2z"/>
                    <GenericEntity
                        phase={entities[Entities.ASSESSMENT_LITERACY].elements[0].phases[Phases.PROCESS_ORIENTED]}
                        result={literacyResult}
                    ...
                    <GenericEntity
                        phase={entities[Entities.ASSESSMENT_LITERACY].elements[0].phases[Phases.SYSTEM_ORIENTED]}
                        result={literacyResult}
                    ...
                    <GenericEntity
                        phase={entities[Entities.ASSESSMENT_LITERACY].elements[0].phases[Phases.CHAIN_ORIENTED]}
                        result={literacyResult}
