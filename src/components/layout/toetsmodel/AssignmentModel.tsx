...
const AssignmentModel: FunctionComponent<Props> = ({results = [3, 3, 3, 3, 3], onPhaseClick}) => {
    ...
    const onClick = (entity: Entity, phase: Phase) =>
        ...
        <div className={'toetsmodel-component'}>
            ...
            >
                ...
                <g id="assessmenttasks">
                    <GenericEntity
                        entity={Entity.ASSESSMENT_TASKS}
                        phase={Phase.ACTIVITY_ORIENTED}
                        result={results[Entity.ASSESSMENT_TASKS]}
                        onPhaseClick={onClick}
                        d="M297.4,182.5c-50.5,0.3-93.3,33.3-108.5,78.8l107.8,34.3L297.4,182.5z"
                    />
                    <GenericEntity
                        entity={Entity.ASSESSMENT_TASKS}
                        phase={Phase.PROCESS_ORIENTED}
                        result={results[Entity.ASSESSMENT_TASKS]}
                        onPhaseClick={onClick}
                ...
                <g id="assessmentprogram">
                    <GenericEntity
                        entity={Entity.ASSESSMENT_PROGRAMME}
                        phase={Phase.ACTIVITY_ORIENTED}
                        result={results[Entity.ASSESSMENT_PROGRAMME]}
                        onPhaseClick={onClick}
                ...
                <g id="assessmentpolicy">
                    <GenericEntity
                        entity={Entity.ASSESSMENT_POLICY}
                        phase={Phase.ACTIVITY_ORIENTED}
                        result={results[Entity.ASSESSMENT_POLICY]}
                        onPhaseClick={onClick}
                ...
                <g id="assessmentorganisation">
                    <GenericEntity
                        entity={Entity.ASSESSMENT_ORGANISATION}
                        phase={Phase.ACTIVITY_ORIENTED}
                        result={results[Entity.ASSESSMENT_ORGANISATION]}
                        onPhaseClick={onClick}
                ...
                <g id="assessmentliteracy">
                    <GenericEntity
                        entity={Entity.ASSESSMENT_LITERACY}
                        phase={Phase.ACTIVITY_ORIENTED}
                        result={results[Entity.ASSESSMENT_LITERACY]}
                        onPhaseClick={onClick}
