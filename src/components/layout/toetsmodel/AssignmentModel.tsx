...
import GenericPhase, {Phase} from "./modules/GenericPhase";
import GenericEntity, {Entity} from "./modules/GenericEntity";
...
const AssignmentModel: FunctionComponent<Props> = ({results}) => {
    ...
    let toetstaken = results && results[0] || -1
    let toetsprogramma = results && results[1] || -1
    let toetsbeleid = results && results[2] || -1
    let toetsorganisatie = results && results[3] || -1
    let toetsbekwaamheid = results && results[4] || -1
        ...
        <div className={"toetsmodel-component"}>
            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
                ...
                <g id="assessmenttasks">
                    <GenericEntity entity={Entity.AssessmentTasks} phase={Phase.ActivityOriented} result={toetstaken}
                                   d="M297.4,182.5c-50.5,0.3-93.3,33.3-108.5,78.8l107.8,34.3L297.4,182.5z"/>
                    <GenericEntity entity={Entity.AssessmentTasks} phase={Phase.ProcessOriented} result={toetstaken}
                                   d="M297.4,182.5l0.2-31.2c-64.6,0.3-119.2,42.3-138.4,100.5l29.7,9.5C204,215.8,246.8,182.9,297.4,182.5z"/>
                    <GenericEntity entity={Entity.AssessmentTasks} phase={Phase.SystemOriented} result={toetstaken}
                                   d="M297.6,151.3l0.2-31.2c-78.6,0.2-145.1,51.4-168.3,122.3l29.7,9.5C178.3,193.7,233,151.6,297.6,151.3z"/>
                    <GenericEntity entity={Entity.AssessmentTasks} phase={Phase.ChainOriented} result={toetstaken}
                                   d="M297.8,120.1l0.2-31.2c-92.6,0.1-171,60.5-198.2,144l29.7,9.5C152.6,171.6,219.2,120.3,297.8,120.1z"/>
                </g>

                <g id="assessmentprogram">
                    <GenericEntity entity={Entity.AssessmentProgram} phase={Phase.ActivityOriented} result={toetsprogramma}
                                   d="M407.5,261.5c-15-45.5-57.7-78.4-108.1-78.9l0.7,113.1L407.5,261.5z"/>
                    <GenericEntity entity={Entity.AssessmentProgram} phase={Phase.ProcessOriented} result={toetsprogramma}
                                   d="M299.2,151.3l0.2,31.2c50.4,0.5,93.1,33.4,108.1,78.9l29.7-9.5C418.1,193.8,363.6,151.8,299.2,151.3z"/>
                    <GenericEntity entity={Entity.AssessmentProgram} phase={Phase.SystemOriented} result={toetsprogramma}
                                   d="M437.2,252l29.7-9.5c-23.1-70.8-89.5-122-167.9-122.4l0.2,31.2C363.6,151.8,418.1,193.8,437.2,252z"/>
                    <GenericEntity entity={Entity.AssessmentProgram} phase={Phase.ChainOriented} result={toetsprogramma}
                ...
                <g id="assessmentpolicy">
                    <GenericEntity entity={Entity.AssessmentPolicy} phase={Phase.ActivityOriented} result={toetsbeleid}
                                   d="M366.6,390.1c28.3-21,46.7-54.6,46.7-92.5c0-11.9-1.8-23.4-5.2-34.2l-107,35.5L366.6,390.1z"/>
                    <GenericEntity entity={Entity.AssessmentPolicy} phase={Phase.ProcessOriented} result={toetsbeleid}
                    ...
                    <GenericEntity entity={Entity.AssessmentPolicy} phase={Phase.SystemOriented} result={toetsbeleid}
                    ...
                    <GenericEntity entity={Entity.AssessmentPolicy} phase={Phase.ChainOriented} result={toetsbeleid}
                ...
                <g id="assessmentorganisation">
                    <GenericEntity entity={Entity.AssessmentOrganisation} phase={Phase.ActivityOriented} result={toetsorganisatie}
                                   d="M231.6,391.5c18.8,13.3,41.7,21.2,66.5,21.2c24.9,0,48-7.9,66.8-21.4l-66.6-90.5L231.6,391.5z"/>
                    <GenericEntity entity={Entity.AssessmentOrganisation} phase={Phase.ProcessOriented} result={toetsorganisatie}
                    ...
                    <GenericEntity entity={Entity.AssessmentOrganisation} phase={Phase.SystemOriented} result={toetsorganisatie}
                    ...
                    <GenericEntity entity={Entity.AssessmentOrganisation} phase={Phase.ChainOriented} result={toetsorganisatie}
                ...
                <g id="assessmentliteracy">
                    <GenericEntity entity={Entity.AssessmentLiteracy} phase={Phase.ActivityOriented} result={toetsbekwaamheid}
                                   d="M188.3,263.2c-3.4,10.9-5.2,22.4-5.2,34.4c0,38.1,18.5,71.8,46.9,92.7l65.7-91.5L188.3,263.2z"/>
                    <GenericEntity entity={Entity.AssessmentLiteracy} phase={Phase.ProcessOriented} result={toetsbekwaamheid}
                    ...
                    <GenericEntity entity={Entity.AssessmentLiteracy} phase={Phase.SystemOriented} result={toetsbekwaamheid}
                    ...
                    <GenericEntity entity={Entity.AssessmentLiteracy} phase={Phase.ChainOriented} result={toetsbekwaamheid}
                ...
                <g id="phases">
                    ...
                    <GenericPhase phase={Phase.SystemOriented} bb={[179, 168]}
                    ...
                    <GenericPhase phase={Phase.ChainOriented} bb={[157, 145]}
                    ...
                    <GenericPhase phase={Phase.SystemOriented} bb={[397, 169]}
                    ...
                    <GenericPhase phase={Phase.ChainOriented} bb={[420, 146]}
                    ...
                    <GenericPhase phase={Phase.SystemOriented} bb={[436, 352]}
                    ...
                    <GenericPhase phase={Phase.ChainOriented} bb={[464, 371]}
                    ...
                    <GenericPhase phase={Phase.ChainOriented} bb={[289, 479]}
                    ...
                    {/* assessmentliteracy */}
                    <GenericPhase phase={Phase.ActivityOriented} bb={[195, 318]}
                                  d="M201,333.5v-2.3h2.7V324h-2.3v-1.8c0.7-0.1,1.2-0.3,1.7-0.5s0.9-0.4,1.4-0.7h2.1v10.1h2.3v2.3H201V333.5z"/>
                    <GenericPhase phase={Phase.ProcessOriented} bb={[165, 331]}
                    ...
                    <GenericPhase phase={Phase.SystemOriented} bb={[136, 344]}
                    ...
                    <GenericPhase phase={Phase.ChainOriented} bb={[110, 359]}
