...
const en: Localization = {
    ...
    "home.entities.text.part2": "A team of a degree course can develop the quality of asessment. Four development phases are distinguished. In the web, these phases of development are symbolized as boxes.",
    ...
    "phase.activityoriented.title": "Activity-oriented phase",
    ...
    "phase.processoriented.title": "Process-oriented phase",
    "phase.processoriented.text": "Relevant employees in the degree course (teachers/examiners, coursemanagement, examination board of examiners, assessment experts/assessment committee, support staff) carry out interrelated process-oriented assessment activities based on short-term policy.",
    "phase.systemoriented.title": "System-oriented phase",
    "phase.systemoriented.text": "All relevant staff and partners in the degree course (students, teachers/examiners, coursemanagement, examination board of examiners, assessment experts/assessment committee, support staff) jointly carry out assessment activities from a medium-term perspective according to the PDCA cycle that are integrated into ongoing processes within the degree course.",
    "phase.chainoriented.title": "Chain-oriented phase",
    "phase.chainoriented.text": "All relevant employees and partners within the degree course and in the chain (students, teachers/examiners, coursemanagement, examination board of examiners, assessment experts/assessment committee, support staff, professional field and external experts) jointly carry out assessment activities from a long-term perspective according to the PDCA cycle that are integrated into ongoing processes within the degree course and the chain."
}
