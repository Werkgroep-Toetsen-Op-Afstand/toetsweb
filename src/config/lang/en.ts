import {Localization, ScanData} from "../../utils/Localization";
...
const en: Localization = {
    ...
    "phase.activityoriented.title": "1. Activity-oriented phase",
    "phase.activityoriented.description": "Individual employees in the degree course (teachers/examiners, coursemanagement, examination board of examiners, assessment experts/assessment committee, support staff) carry out parts of assessment activities on an ad hoc basis, whereby there is no attention to the interrelationship between these activities.",
    "phase.processoriented.title": "2. Process-oriented phase",
    "phase.processoriented.description": "Relevant employees in the degree course (teachers/examiners, coursemanagement, examination board of examiners, assessment experts/assessment committee, support staff) carry out interrelated process-oriented assessment activities based on short-term policy.",
    "phase.systemoriented.title": "3. System-oriented phase",
    "phase.systemoriented.description": "All relevant staff and partners in the degree course (students, teachers/examiners, coursemanagement, examination board of examiners, assessment experts/assessment committee, support staff) jointly carry out assessment activities from a medium-term perspective according to the PDCA cycle that are integrated into ongoing processes within the degree course.",
    "phase.chainoriented.title": "4. Chain-oriented phase",
