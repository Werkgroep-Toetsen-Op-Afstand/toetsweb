...
export const nl: Localization = {
    ...
    "home.startScanButton": "Start de Toetsweb-Scan",
    ...
    "phase.activityoriented.title": "Activiteiten-georiënteerde fase",
    ...
    "phase.processoriented.title": "Proces-georiënteerde fase",
    "phase.processoriented.text": "Relevante medewerkers in de opleiding (docenten/examinatoren, opleidingsmanagement, examencommissie, toetsexperts/toetscommissie, ondersteunende medewerkers) voeren vanuit een korte termijn perspectief procesmatig toetsactiviteiten uit die onderling samenhangen.",
    "phase.systemoriented.title": "Systeem-georiënteerde fase",
    "phase.systemoriented.text": "Alle relevante medewerkers en partners in de opleiding (studenten, docenten/examinatoren, opleidingsmanagement, examencommissie, toetsexperts/toetscommissie, ondersteunende medewerkers) voeren gezamenlijk vanuit een middellange termijn perspectief volgens de PDCA-cyclus toetsactiviteiten uit die zijn geïntegreerd in lopende processen binnen de opleiding.",
    "phase.chainoriented.title": "Keten-georiënteerde fase",
