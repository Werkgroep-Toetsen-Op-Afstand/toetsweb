...
export const nl: Localization = {
    ...
    "phase.activityoriented.title": "1. Activiteiten-georiënteerde fase",
    ...
    "phase.processoriented.title": "2. Proces-georiënteerde fase",
    ...
    "phase.systemoriented.title": "3. Systeem-georiënteerde fase",
    ...
    "phase.chainoriented.title": "4. Keten-georiënteerde fase",
...
export const nlScanData: ScanData = {
    entities: [
        {
            name: "Toets(tak)en",
            elements: [
